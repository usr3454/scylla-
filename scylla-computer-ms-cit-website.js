...
const courseData = {
  mscit: {
    ...
    message: "Namaste Scylla Computer, I want to ask about MS-CIT admission."
  },
  office: {
    kicker: "Daily work skills",
    title: "Office Skills",
    selectValue: "Office Skills",
    text: "Practice documents, spreadsheets, presentations, file handling, and useful workflows for study or office work.",
    skills: ["MS Word", "Excel basics", "PowerPoint", "Print-ready documents"],
    message: "Namaste Scylla Computer, I want to ask about Office Skills training."
  },
  typing: {
    kicker: "Beginner friendly",
    title: "Typing & Computer Basics",
    selectValue: "Typing & Basics",
    text: "Start with keyboard comfort, mouse handling, typing practice, folders, files, and everyday computer tasks.",
    skills: ["Keyboard practice", "Mouse control", "Files and folders", "Basic internet"],
    message: "Namaste Scylla Computer, I want to ask about Typing and Computer Basics."
  },
  career: {
    kicker: "Practical confidence",
    title: "Career Digital Skills",
    selectValue: "Career Skills",
    text: "Learn useful digital tasks such as email, online forms, document uploads, scanning, and essential student services.",
    skills: ["Email", "Online forms", "PDF handling", "Digital tasks"],
    message: "Namaste Scylla Computer, I want to ask about Career Digital Skills."
  }
};
